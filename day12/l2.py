...
shortest, path, d = dijkstra.dijkstra(c2s(end[0], end[1]), c2s(start[0], start[1]), graph)

print(shortest)
print(d[c2s(start[0], start[1])])

print(min([d.get(a, 5555555555555555) for a in list_a]))
